...
const Clock= styled.header`
 ...
 .clock-box svg{
     ...
     background: linear-gradient(164deg, rgba(2,0,36,1) 0%, rgba(21,25,50,1) 0%, rgba(46,51,91,1) 100%);
...
export default function Figure({load=70, child="COUNTER"}) {
    load = load*250/100
  return (
      <Clock>
      <div className="clock">
          ...
          <div className="main">
            ...
            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
               ...
               <path  className="shadow" fill="none" stroke-linecap="round" stroke-width="3" stroke="#F07675"
                     stroke-dasharray={`${load},251.2`}
                     d="M50 10
                        a 40 40 0 0 1 0 80
                        a 40 40 0 0 1 0 -80"/>
                <path   fill="none" stroke-linecap="round" stroke-width="3" stroke="#F07675"
                      stroke-dasharray={`${load},251.2`}
                      d="M50 10
                         a 40 40 0 0 1 0 80
                         a 40 40 0 0 1 0 -80"/>
